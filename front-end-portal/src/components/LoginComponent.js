        ...
        return (
            <div className="container">
                ...
                <div className="container">
                    ...
                    User Name: <input className= "userNameBox" type="text" placeholder="Neil" name="username" value={this.state.username} onChange={this.handleChange} onKeyPress={this.enterPressed.bind(this)}></input>
                    Password: <input className= "userNameBox" type="password" id="myInput" name="password" value={this.state.password} onChange={this.handleChange} onKeyPress={this.enterPressed.bind(this)}></input>
                    <hr></hr>
